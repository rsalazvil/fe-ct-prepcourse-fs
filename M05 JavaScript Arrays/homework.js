...
function promedioResultadosTest(resultadosTest) {
   ...
   for (let i = 0; i < resultadosTest.length; i++) {
      var total = total + resultadosTest[i];
   }
...
function mesesDelAño(array) {
   ...
   for (let i = 0; i < array.length; i++) {
      if  (array[i] == "Enero") {
         ...
         existe.push("Noviembre"); 
      } 
   }
      if (existe.includes("Enero") && existe.includes("Marzo") && existe.includes("Noviembre")) {
                 return existe;
...
function breakStatement(num) {
   ...
   // la ejecución y retornar el string: "Se interrumZpió la ejecución".
